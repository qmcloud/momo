...
var menus = []model.SysBaseMenu{
	...
	{GVA_MODEL: global.GVA_MODEL{ID: 22, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, ParentId: "0", Path: "https://github.com/DOUBLE-Baller/momo", Name: "https://github.com/DOUBLE-Baller/momo", Hidden: false, Component: "/", Sort: 0, Meta: model.Meta{Title: "Github", Icon: "s-home"}},
