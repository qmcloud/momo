...
class Push extends Form
{
    ...
    public $option_name = 'configpris_push';
    /**
    ...
    {
        $this->switch('letter_switch', '私信开关')->states([
            'on'  => ['value' => 1, 'text' => '打开', 'color' => 'primary'],
            'off' => ['value' => 2, 'text' => '关闭', 'color' => 'default'],
        ]);

        $this->switch('jpush_sandbox',"极光推送模式")->states([
            'on'  => ['value' => 1, 'text' => '打开', 'color' => 'primary'],
            'off' => ['value' => 2, 'text' => '关闭', 'color' => 'default'],
        ]);

        $this->text('login_wx_appid',"极光推送APP_KEY");

        $this->text('login_wx_appsecret',"极光推送master_secret");
