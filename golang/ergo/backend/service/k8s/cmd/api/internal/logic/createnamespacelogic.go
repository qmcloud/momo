...
func (l *CreateNamespaceLogic) CreateNamespace(req types.RequestEmpty) (*types.Response, error) {
	...
	return nil, errorx.NewCodeError(200, "namespace-create-success", createNamespace)
}
