...
<body>
	<div class="wrap">
		...
		<form class="well form-search" method="post" action="<?php echo U('Liveban/index');?>">
			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					<?php if(is_array($lists)): foreach($lists as $key=>$vo): ?><tr>
                        ...
                        <td><?php echo ($vo['superinfo']['user_nicename']); ?> (<?php echo ($vo['superinfo']['id']); ?>)</td>
						<td><?php echo (date("Y-m-d H:i:s",$vo["addtime"])); ?></td>						
						<td align="center">	
						
						    <a href="<?php echo U('Liveban/del',array('id'=>$vo['liveuid']));?>" >删除</a> 
						</td>
