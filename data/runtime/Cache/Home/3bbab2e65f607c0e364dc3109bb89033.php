...
<html>
	...
	<body>
		...
		<div class="SR-pager" id="LF-pager">
			<div class="SR-nav" id="LF-nav" style="display:none;">
				<!--左侧导航-->
				<div class="nav-fg" style="display:none;">
					<h1>
...
<!-- 						<li class="had-dialog" id="LF-toggle-square">
				...
				<!--左侧底部导航-->
				<div class="nav-link " id="LF-nav-link" style="display:none;">
					<ul>
							<li class="share">
									<div class="icon">
											<dl>
			...
			<div class="SR-stager clearfix" id="LF-stager">
				...
				<div class="SR-area-info" id="LF-area-info">
					...
					<!-- 主播信息 -->
					<div class="SR-anchor-info" style="background-color:transparent;">
						<div class="SR-anchor-info-top">
							<div class="SR-anchor-info-avatar">
								<img class="anchor_avatar" src="<?php echo ($anchorinfo['avatar']); ?>">
								<img class="anchor_grade levelanchor" src="<?php echo ($levelanchorlist[$anchorinfo['level_anchor']]['thumb_mark']); ?>">
							</div>
					...
					<!-- 排行榜 -->
					<div class="info-rank" id="LF-info-rank"  style="display:none;">
						<div class="MR-rank">
							<ul class="tab">
					...
					<!--用户列表-->
				<div class="nav-bg" id="LF-nav-bg" style="display:none;">
				...
				<div class="SR-area-video" id="LF-area-video">
					...
					<div class="channel-player-v2" chromeq="1" id="container_play" style="display:none" >
                        <div id="playerzmblbkjP" style="width:100%;height:100%;z-index:1;"></div>
                    </div>
					<?php else: ?>
					...
					<!-- 主播信息 -->
					<div class="MR-about" style="display:none;">
						<dl class="clearfix">
					...
					<!--点亮start-->
					<div id="player-praises" data-bk="player-praises" style="display:none;"> 
						<div class="bubble"> 
						</div> 
					...
					<div class="gift_effect_area" style="diaplay:none">
						<div class="hjPopbox"> 
						</div>
					</div>
				</div>
				<!-- 信息通知 -->
				<div class="SR-area-chat" id="LF-area-chat" style=" background-color:transparent; ">
 ...
 class="chat-gift" id="LF-chat-gift">
						<div class="MR-gift">
				...
				<!-- 坐骑 -->
				<div class="MR-enter-fx" id="LF-enter-fx" style="display:none;">
