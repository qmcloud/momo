...
<body>
    ...
    <div class="search-bar">
        <div class="search-bar--contents">
            ...
            <div class="flex flex-1 pl5 pr5">
                <div class="ui-input-text outline">
                    <input type="text">
                </div>
            </div>
            <div class="flex">
                <a href="/" class="ui-button-rectangle radius5 p5 outline">取消</a>
            </div>
        </div>
    </div>
    <main class="">
    ...
    <?php default: ?>普通房间<?php endswitch;?>
        ...
        <footer>
            <div class="tabbar">
                ...
                <a href=""><i class="icon icon-1v1 size35"></i></a>
                ...
                <a href=""><i class="icon icon-chat size35"></i></a>
                <a href=""><i class="icon icon-myL size35"></i></a>
            </div>
        </footer>
    </main>
