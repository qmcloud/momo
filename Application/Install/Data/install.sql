...
VALUES
  ...
  (2,'网站标题','WEB_SITE_TITLE','admin',1,'text','','网站标题前台显示标题',1378898976,1379235274,2,1),
  ...
  (6,'网站描述','WEB_SITE_DESCRIPTION','admin是一套轻量级通用后台，追求简单、高效、卓越。',1,'textarea','','网站搜索引擎描述',1378898976,1379235841,6,1),
  (7,'网站关键字','WEB_SITE_KEYWORD','admin 、',1,'textarea','','网站搜索引擎关键字',1378898976,1381390100,7,1),
  (8,'版权信息','WEB_SITE_COPYRIGHT','Copyright ©  All rights reserved.',1,'text','','设置在网站底部显示的版权信息，如“版权所有 © 不得商用”',1406991855,1406992583,8,1),
