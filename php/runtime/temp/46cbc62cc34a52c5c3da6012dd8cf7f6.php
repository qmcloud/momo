<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"/www/wwwroot/live/public/../application/admin/view/idcard/edit.html";i:1684618279;s:60:"/www/wwwroot/live/application/admin/view/layout/default.html";i:1671020443;s:57:"/www/wwwroot/live/application/admin/view/common/meta.html";i:1671020443;s:59:"/www/wwwroot/live/application/admin/view/common/script.html";i:1671020443;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-cer_no" data-rule="required" class="form-control" name="row[cer_no]" type="text" value="<?php echo htmlentities($row['cer_no']); ?>">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-front_view" data-rule="required" class="form-control" size="50" name="row[front_view]" type="text" value="<?php echo htmlentities($row['front_view']); ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-back_view" data-rule="required" class="form-control" size="50" name="row[back_view]" type="text" value="<?php echo htmlentities($row['back_view']); ?>">
                <div class="input-group-addon no-border no-padding">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-handset_view" data-rule="required" class="form-control" size="50" name="row[handset_view]" type="text" value="<?php echo htmlentities($row['handset_view']); ?>">
                <div class="input-group-addon no-border no-padding">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-reason" class="form-control " rows="5" name="row[reason]" cols="50"><?php echo htmlentities($row['reason']); ?></textarea>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-uptime" data-rule="required" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[uptime]" type="text" value="<?php echo $row['uptime']?datetime($row['uptime']):''; ?>">
        </div>
    </div>
    <div class="form-group">
