define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'loginbonus/index' + location.search,
                    add_url: 'loginbonus/add',
                    edit_url: 'loginbonus/edit',
                    del_url: 'loginbonus/del',
                    multi_url: 'loginbonus/multi',
                    import_url: 'loginbonus/import',
                    table: 'loginbonus',
                }
            });
