define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'pushrecord/index' + location.search,
                    add_url: 'pushrecord/add',
                    edit_url: 'pushrecord/edit',
                    del_url: 'pushrecord/del',
                    multi_url: 'pushrecord/multi',
                    import_url: 'pushrecord/import',
                    table: 'pushrecord',
                }
            });
