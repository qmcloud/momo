define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'chargerules/index' + location.search,
                    add_url: 'chargerules/add',
                    edit_url: 'chargerules/edit',
                    del_url: 'chargerules/del',
                    multi_url: 'chargerules/multi',
                    import_url: 'chargerules/import',
                    table: 'charge_rules',
                }
            });
