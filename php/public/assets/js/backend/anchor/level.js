define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'anchor/level/index' + location.search,
                    add_url: 'anchor/level/add',
                    edit_url: 'anchor/level/edit',
                    del_url: 'anchor/level/del',
                    multi_url: 'anchor/level/multi',
                    import_url: 'anchor/level/import',
                    table: 'level_anchor',
                }
            });
